...
# sh import-external-repo.sh git@github.com:O-clock-Hyperion/S05-projet-oShop-charlesen.git nom-de-la-branche-a-creer [nom-de-la-branche-source]
#
# l'argument "git@github.com:O-clock-Hyperion/S05-projet-oShop-charlesen.git" correspond au lien permettant de cloner le dépôt
