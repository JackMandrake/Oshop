...
<html lang="fr">
  ...
  <head>
    ...
    <link rel="stylesheet" href="<?= $viewVars['BASE_URI'] ?>/assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?= $viewVars['BASE_URI'] ?>/assets/css/font-awesome.min.css">
    <link rel="stylesheet" href="<?= $viewVars['BASE_URI'] ?>/assets/css/styles.css">
    <title>oShop</title>
  </head>
  ...
  <body>
    <header>
      ...
      <nav class="navbar navbar-expand-lg navbar-sticky navbar-airy navbar-light">
        <div class="container-fluid">
          <!-- Navbar Header  -->
          <!-- /oclock/hyperion/s05/s05-projet-oShop-charlesen/public/ -->
          ...
          <div id="navbarCollapse" class="collapse navbar-collapse">
            <ul class="navbar-nav mx-auto">
              ...
              <li class="nav-item">
                <a href="<?= $router->generate('catalog_category_list') ?>" class="nav-link">Catégories</a>
              </li>
              <li class="nav-item">
                <a href="<?= $router->generate('catalog_type_list') ?>" class="nav-link">Types de produit</a>
              </li>
              <li class="nav-item">
                <a href="<?= $router->generate('catalog_brand_list') ?>" class="nav-link">Marques</a>
              </li>
              <li class="nav-item">
                <a href="<?= $router->generate('blog') ?>" class="nav-link">Blog</a>
              </li>
              <li class="nav-item">
                <a href="<?= $router->generate('blog') ?>" class="nav-link">Contact</a>
              </li>
            </ul>
