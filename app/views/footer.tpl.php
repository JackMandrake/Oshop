        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
            ...
            <ul class="list-unstyled">
              ...
              <?php foreach($footerFiveType as $typeOb): ?>
                <li> 
                  <a href="<?=$router->generate('catalog_type', ['type_id'=>$typeOb->getId()]) ?>" class="text-muted">
                    <?= $typeOb->getName() ?>
                  </a>
                </li>
              <?php endforeach; ?>
          ...
          <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
            ...
            <ul class="list-unstyled">
              <?php foreach($footerFiveBrands as $brandOb): ?>
                <li> 
                <a href="<?=$router->generate('catalog_brand', ['brand_id'=>$brandOb->getId()]) ?>" class="text-muted">
                    <?= $brandOb->getName() ?>
                  </a>
                </li>
              <?php endforeach; ?>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-6">
            <ul class="list-inline mb-0 mt-2 mt-md-0 text-center text-md-right">
              <li class="list-inline-item">
                <img src="<?= $viewVars['BASE_URI'] ?>/assets/images/visa.svg" alt="..." class="payment-icon">
              </li>
              <li class="list-inline-item">
                <img src="<?= $viewVars['BASE_URI'] ?>/assets/images/mastercard.svg" alt="..." class="payment-icon">
              </li>
              <li class="list-inline-item">
                <img src="<?= $viewVars['BASE_URI'] ?>/assets/images/paypal.svg" alt="..." class="payment-icon">
              </li>
            </ul>
          </div>
        </div>
...
//]]></script>
  <!-- JS -->
  <script src="<?= $viewVars['BASE_URI'] ?>/assets/js/jquery.min.js"></script>
  <script src="<?= $viewVars['BASE_URI'] ?>/assets/js/popper.min.js"></script>
  <script src="<?= $viewVars['BASE_URI'] ?>/assets/js/bootstrap.min.js"></script>
  <script src="<?= $viewVars['BASE_URI'] ?>/assets/js/app.js"></script>
</body>
