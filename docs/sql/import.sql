...
CREATE TABLE IF NOT EXISTS `brand` (
  ...
  `updated_at` DATETIME NULL COMMENT 'La date de la dernière mise à jour de la marque',
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `category` (
  ...
  `updated_at` DATETIME NULL COMMENT 'La date de la dernière mise à jour de la catégorie',
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  `updated_at` DATETIME NULL COMMENT 'La date de la dernière mise à jour du produit',
